...
with col_main:
    ...
    # ---------------------------------------------------------
    # 5. JavaScript (★ 核心：border-bottom 分隔線)
    # ---------------------------------------------------------
    html_code = f"""
    <!DOCTYPE html>
    <html>
    <head>
        ...
        <style>
            ...
            /* ★ Chart Container: 增加底部邊框 (Divider) 和間距 (Spacing) */
            .chart-container {{ 
                position: relative; 
                width: 100%; 
                border-bottom: 1px solid #E0E0E0; /* 淺灰分隔線 */
                margin-bottom: 10px; /* 圖表間距 */
            }}
